    ...
    return new Promise(function(resolve, reject) {
      ...
      if(path!=null){
        ...
        $plus.plusReady(()=>{
          ...
          let operationFun = function(fullPath){
            ...
            // 缓存目录 downloads/image/(md5).jpg
            let image_md5           = md5(image_url);
            // 缓存本地图片url
            let local_image_url     = 'downloads/image/'+image_md5+'.' + ext;
            // 平台绝对路径
            let absolute_image_path = fullPath + local_image_url
