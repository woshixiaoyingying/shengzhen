        ...
        >
          <div class="item m20" v-for="(item,index) in listData" :key="index">
            ...
            <div class="mt20 mb20 tr">
              <a class="btn btn-mini" @click="ucenterApiMessageDel(item.id,index)">删除</a>
            </div>			
          </div>
        </van-list>
      </div>
...
export default {
  ...
  methods: {
    ...
    ucenterApiMessageDel(id,index){
      ...
      this.$store.dispatch({type:"ucenterApiMessageDel",params,successCallback})
    }
